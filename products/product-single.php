...
if (isset($_GET['id'])) {
	...
	$allReatedProducts = $relatedProducts->fetchAll(PDO::FETCH_OBJ);
	...
	if (isset($_POST['submit'])) {
		...
		if (isset($_SESSION['user_id'])) {
			...
			$validation = $conn->prepare("SELECT * FROM cart WHERE pro_id = '$id' AND user_id = '$_SESSION[user_id]'");
			$validation->execute();
		...
		<div class="row">
			...
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				...
				<form method="POST" action="product-single.php?id=<?php echo $id; ?>">
					...
					<input value="<?php echo $singleProduct->name; ?>" name="name" type="hidden">
					<input value="<?php echo $singleProduct->image; ?>" name="image" type="hidden">
					<input value="<?php echo $singleProduct->price; ?>" name="price" type="hidden">
					<input value="<?php echo $singleProduct->id; ?>" name="pro_id" type="hidden">
					<input value="<?php echo $singleProduct->description; ?>" name="description" type="hidden">
